...
const departamento = require('./components/departamentos/departamento-network')
const marca = require('./components/marcas/marca-network')
const modelo = require('./components/modelos/modelo-network')
